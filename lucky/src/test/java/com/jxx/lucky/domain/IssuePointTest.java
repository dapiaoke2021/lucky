...
//    }
    ...
    private void assertTopMap(Map<BetTypeEnum, Integer> topBetMap, Integer...expectedTops) {
        ...
        Assertions.assertEquals(expectedTops[4], topBetMap.get(BetTypeEnum.NIU_NIU));
        Assertions.assertEquals(expectedTops[5], topBetMap.get(BetTypeEnum.NIU_1));
        Assertions.assertEquals(expectedTops[6], topBetMap.get(BetTypeEnum.NIU_2));
        Assertions.assertEquals(expectedTops[7], topBetMap.get(BetTypeEnum.NIU_3));
        Assertions.assertEquals(expectedTops[8], topBetMap.get(BetTypeEnum.NIU_4));
        Assertions.assertEquals(expectedTops[9], topBetMap.get(BetTypeEnum.NIU_5));
        Assertions.assertEquals(expectedTops[10], topBetMap.get(BetTypeEnum.NIU_6));
        Assertions.assertEquals(expectedTops[11], topBetMap.get(BetTypeEnum.NIU_7));
        Assertions.assertEquals(expectedTops[12], topBetMap.get(BetTypeEnum.NIU_8));
        Assertions.assertEquals(expectedTops[13], topBetMap.get(BetTypeEnum.NIU_9));
    }
